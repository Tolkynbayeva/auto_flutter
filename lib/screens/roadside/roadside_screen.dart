import 'dart:convert';
import 'package:auto_flutter/screens/roadside/article_screen.dart';
...
class _RoadsideScreenState extends State<RoadsideScreen> {
  ...
  Future<void> _loadSolutions() async {
    final String response =
        await rootBundle.loadString('assets/roadside_solutions.json');
  ...
  return GestureDetector(
    onTap: () {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ArticleScreen(solution: solution),
        ),
      );
    },
    child: Stack(
